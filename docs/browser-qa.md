...
The browser flow covers onboarding, one completed workout, set review, a manual meal,
history, Settings, reload persistence, newer-tab SQLite handoff, mobile overflow and
